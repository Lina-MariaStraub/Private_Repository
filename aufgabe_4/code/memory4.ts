...
namespace Memory_3 {
    ...
    let anzahlKartenpaare: number = 0;//Variable für die Kartenanzahl um im Popup die Anzahl der Kartenpaare zu wählen
    ...
    let l: number = 0; //Variable l für die spätere Gratulation erstellen, prüft ob alle Karten genommen wurde (l==anzahlKartenpaare)
    ...
    function main(): void {//Funtkion main aufstellen
        ...
        let i: boolean = true;//Variable i definieren,, wenn i wahr ist sprich Anzahl der Spieler bei 1-4

        while ( i ) {

            anzahlSpieler = parseInt( prompt( "Bitte wählen Sie zwischen 1 und 4 Spielern" ), 10 );//Popup für SPIELER_ANZEIGE---------
        ...
        for ( let i: number = 0; i < anzahlSpieler; i++ ) {//Schleife erzeugen für Abfrage der SPIELER_NAMEN---------------
