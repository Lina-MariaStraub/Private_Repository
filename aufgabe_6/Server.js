...
var Http = require("http"); //HTTP Objekt wird im Code erstellt
...
(function (Node) {
    ...
    function handleRequest(_request, _response) {
        _response.setHeader('Access-Control-Allow-Origin', '*'); //Header um von andren Severn zugreifen zu k�nnen
