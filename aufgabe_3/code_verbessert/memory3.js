...
var Memory_3;
(function (Memory_3) {
    var anzahlSpieler = 0; //Variable f�r die Anzahl der Spieler
    var anzahlKartenpaare = 0; //Variable f�r die Kartenanzahl 
    var offeneKarten = []; //leeres Array, hier landen die angeklickten karten und hier vergleich ob sie gleich sind
    var counter = 0; //Variable counter anlegen, damit nur 2 Karten aufgedeckt werden
    var l = 0; //Variable l f�r die sp�tere Gratulation erstellen
    ...
    function main() {
        ...
        var i = true; //Variable i definieren,, wenn i wahr ist
        while (i) {
